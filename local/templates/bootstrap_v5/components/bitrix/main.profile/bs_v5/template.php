...
<table class="data-table profile-table">
	...
	<p><input type="submit" class="btn btn-success" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="btn btn-outline-danger" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?
