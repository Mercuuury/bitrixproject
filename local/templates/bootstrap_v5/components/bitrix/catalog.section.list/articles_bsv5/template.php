...
?><div class="card-body <? echo $arCurView['CONT']; ?>"><?
...
{
?>
<h5 class="card-title mb-3">Категории статей</h5>
	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TEXT':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"><p class="fs-6"><a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? echo $arSection['NAME']; ?></a><?
				if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
				{
					?> <span>(<? echo $arSection['ELEMENT_CNT']; ?>)</span><?
				}
