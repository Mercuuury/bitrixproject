	...
	?>
		...
		?>
			...
			<div class="<?= $className ?>" id="blg-post-<?= $arResult["Post"]["ID"] ?>">
				<h2 class="bs-blog-post-title"><span><?= $arResult["Post"]["TITLE"] ?></span></h2>
				...
				<div class="blog-post-meta">
					...
					<div class="blog-post-meta-util">
						<span class="blog-post-views-link"><a class="link-dark" href=""><span class="blog-post-link-caption"><?= GetMessage("BLOG_BLOG_BLOG_VIEWS") ?></span><span class="blog-post-link-counter"><?= intval($arResult["Post"]["VIEWS"]) ?></span></a></span>
						...
						<? if ($arResult["urlToHide"] <> '') : ?>
							<span class="blog-post-hide-link"><a class="link-secondary" href="javascript:if(confirm('<?= GetMessage("BLOG_MES_HIDE_POST_CONFIRM") ?>')) window.location='<?= $arResult["urlToHide"] . "&" . bitrix_sessid_get() ?>'"><span class="blog-post-link-caption"><?= GetMessage("BLOG_MES_HIDE") ?></span></a></span>
						<? endif; ?>
						<? if ($arResult["urlToEdit"] <> '') : ?>
							<span class="blog-post-edit-link"><a class="link-warning" href="<?= $arResult["urlToEdit"] ?>"><span class="blog-post-link-caption"><?= GetMessage("BLOG_BLOG_BLOG_EDIT") ?></span></a></span>
						<? endif; ?>
						<? if ($arResult["urlToDelete"] <> '') : ?>
							<span class="blog-post-delete-link"><a class="link-danger" href="javascript:if(confirm('<?= GetMessage("BLOG_MES_DELETE_POST_CONFIRM") ?>')) window.location='<?= $arResult["urlToDelete"] . "&" . bitrix_sessid_get() ?>'"><span class="blog-post-link-caption"><?= GetMessage("BLOG_BLOG_BLOG_DELETE") ?></span></a></span>
						<? endif; ?>
