...
<body>
    <p class="center">Космические захватчики уничтожили эту страницу! Отомсти им!
        <br /> Используй <span class="label label-danger">Пробел</span> для стрельбы и <span class="label label-danger">←</span>&#160;<span class="label label-danger">→</span> для управления!&#160;&#160;&#160;<button class="btn btn-default btn-xs" id="restart">Перезапустить</button>
    </p>
        ...
        Game.prototype = {
            ...
            draw: function() {
                ...
                if (this.lost) {
                    ...
                    screen.fillText("Вы проиграли", gameSize.width / 2, gameSize.height / 2);
                    screen.font = "20px Lucida Console";
                    screen.fillText("Счет: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
                    ...
                    screen.fillText("Счет: " + kills, gameSize.width, gameSize.height - 12);
                }
